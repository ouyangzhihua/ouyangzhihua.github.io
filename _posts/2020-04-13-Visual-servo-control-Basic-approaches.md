...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth]{figure/ibvs_model.png}
	\caption{ibvs仿真模型}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{figure/traj1_pbvs.eps}
	\includegraphics[scale=0.5]{figure/row1_pbvs.eps}
	\includegraphics[scale=0.5]{figure/v1_pbvs.eps}
	\caption{仿真结果}
\end{figure}
